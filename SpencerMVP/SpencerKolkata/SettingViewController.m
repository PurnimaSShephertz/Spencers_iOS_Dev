...
//        profile.mobile = self.mobileTextField.text;
        ...
        if ([self.firstNameTextField.text isEqualToString:@""] || [self.lastNameTextField.text isEqualToString:@""] ) {
            ...
            [authLayer requestChangePasswordUserName:nil oldPassword:self.firstNameTextField.text newPassword:self.lastNameTextField.text completionHandler:^(NSString *responseString, NSError *error) {
