...
+ (void)initialize
{
	if (self == [TWDefaultMessageBarStyleSheet class])
	{
        ...
        kTWDefaultMessageBarStyleSheetInfoBackgroundColor = [UIColor colorWithRed:3.0/255.0 green:132.0/255.0 blue:36.0/255.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // blue
        
//        [UIColor colorWithRed:86.0/255.0 green:134.0/255.0 blue:0.0/255.0 alpha:1];
